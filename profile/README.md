...
| [nomad-camels-plugin](https://github.com/FAIRmat-NFDI/nomad-camels-plugin) | A NOMAD plugin that allows you to automatically parse data files created by [NOMAD CAMELS](https://github.com/FAU-LAP/NOMAD-CAMELS) | [📚](https://fairmat-nfdi.github.io/nomad-camels-plugin/) |   
