...
| [pynxtools-mpes](https://github.com/FAIRmat-NFDI/pynxtools-mpes/) | pynxtools reader plugin for X-ray photoelectron spectroscopy (XPS) data from various vendors/sources. | | [📦](https://pypi.org/project/pynxtools-mpes/) |
